...
class TopicSearcher:
    ...
    def search_by_keyword(self, keyword: str, collection_name: str, limit: int = 5) -> List[Dict[str, Any]]:
        """
    ...
    def search_multiple_topics(self, topics: List[str], collection_name: str, 
                             limit_per_topic: int = 3) -> Dict[str, List[Dict[str, Any]]]:
        """
...
def search_topics_from_json(json_file_path: str, collection_name: str = None, 
                           limit_per_topic: int = 3) -> Dict[str, Any]:
    """
    ...
    if collection_name is None:
        ...
        filename = filename.replace('_complete_test', '').replace('_keywords_summary', '')
    ...
    # 4. 토픽별 검색 수행
    search_results = searcher.search_multiple_topics(topics, collection_name, limit_per_topic)
    ...
    result_summary = {
        ...
        'summary': {
            ...
            'empty_topics': [topic for topic, results in search_results.items() if not results]
        }
    }
