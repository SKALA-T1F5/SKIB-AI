...
async def run_test():
    ...
    test_grading_criteria = [
        GradingCriterion(
            score=0, criteria="관련 없는 설명", example=".", note="관련 없는 설명"
        ),
        GradingCriterion(
            score=1,
            criteria="AI와 ML의 구분이 없는 설명",
            example="AI는 똑똑한 기술이에요",
            note="구분 없이 추상적으로 설명",
        ),
        GradingCriterion(
            score=3,
            criteria="AI와 ML의 기본적 구분 설명",
            example="AI는 넓은 개념이고 ML은 그 하위",
            note="틀리진 않지만 설명이 짧음",
        ),
        GradingCriterion(
            score=5,
            criteria="AI와 ML의 관계 및 차이를 구체적으로 설명",
            example="AI는 포괄 개념, ML은 데이터 학습 기반 기술",
            note="정확하고 구체적인 설명",
        ),
    ]
