...
class TestConfigGenerator:
    ...
    def generate_config(self, requirements: Dict[str, Any], test_summary: str) -> Dict[str, Any]:
        """테스트 설정 생성"""
        
        difficulty = requirements.get("difficulty", "medium")
        test_type = requirements.get("test_type", "mixed")
        question_count = requirements.get("question_count", {"objective": 5, "subjective": 3})
        ...
        config = {
            ...
            "question_config": {
                "total_questions": question_count["objective"] + question_count["subjective"],
    ...
    def _calculate_distribution(self, question_count: Dict[str, int]) -> Dict[str, float]:
        """문제 유형별 분포 계산"""
    ...
    def _generate_scoring_config(self, question_count: Dict[str, int]) -> Dict[str, Any]:
        """채점 설정 생성"""
        obj_points = self.scoring_templates["objective"]["points"]
        subj_points = self.scoring_templates["subjective"]["points"]
        
        total_points = (question_count["objective"] * obj_points) + (question_count["subjective"] * subj_points)
    ...
    def _generate_generation_config(self, requirements: Dict[str, Any]) -> Dict[str, Any]:
        """문제 생성 설정"""
        difficulty = requirements.get("difficulty", "medium")
    ...
    def _determine_content_emphasis(self, special_requirements: List[str]) -> Dict[str, float]:
        """내용 강조점 결정"""
        emphasis = {
            "facts": 0.3,
            "concepts": 0.3,
    ...
    def _generate_constraints(self, requirements: Dict[str, Any], difficulty: str) -> Dict[str, Any]:
        """생성 제약조건"""
